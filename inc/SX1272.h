...
const uint16_t MAX_TIMEOUT = 3000;		//8000 msec = 8.0 sec
...
public:
	...
	*/
	...
	//! It stores the last ACK received packet at the address provided by the caller after verificaiton of the source address
	/*!
	 *
	\return '0' on success, '1' otherwise
	*/
	int8_t getAckPacket(uint8_t src, uint8_t *payload, uint8_t *size);
